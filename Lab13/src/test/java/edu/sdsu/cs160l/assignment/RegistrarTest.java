...
public class RegistrarTest {
  ...
  public void printEnrolledStudentsByMajorAndCourseName(){
    StudentMajor major = StudentMajor.COMPUTER_SCIENCE;
    String courseNameStartWith = "COMP";
    registrar.getStudentsEnrolled(major, courseNameStartWith)
            .forEach(e -> System.out.println(e));
  }
  ...
  public void printGetStudentsGpa(){
    StudentMajor major = StudentMajor.COMPUTER_SCIENCE;
    String courseNameStartWith = "COMP";
    registrar.getStudentsGpa(major, courseNameStartWith)
            .forEach(e -> System.out.println(e));
  }
  ...
  public void printTopNStudentRedIdsWithHighestScoreInEachCourse(){
    int n = 3;
    System.out.println("Top " + n + " student red IDs for each course:");
    registrar.topNStudentRedIdsWithHighestScoreInEachCourse(n)
            .forEach(e -> System.out.println(e));
  }

  @Test
  public void printAverageCourseUnitsByAllStudentsAcrossAllCourse(){
    System.out.println(registrar.averageCourseUnitsByAllStudentsAcrossAllCourse());
  }

  @Test
  public void printAverageCourseUnitsByAllStudentsAcrossAllNonComputerCourse(){
    System.out.println(registrar.averageCourseUnitsByAllStudentsAcrossAllNonComputerCourse());
  }
