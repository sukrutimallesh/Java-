...
public abstract class Course {
    ...
    public void addStudent(Student studentToBeEnrolled) throws StudentAlreadyEnrolledException, ClassFullException {
        ...
        if(studentToBeEnrolled == null){
            throw new NullPointerException("Student to be enrolled is null");
        }
        ...
        if(studentAlreadyPresent(studentToBeEnrolled)){
            throw new StudentAlreadyEnrolledException("The student is already enrolled in the class");
        }
        ...
        if(isClassFull()){
            throw new ClassFullException("The class is full");
        }
